...
#ifndef NGB_BYTE_VALUE_PARSER_H__
#define NGB_BYTE_VALUE_PARSER_H__
...
class ByteValueParser : public ValueParser
{
  ...
  bool parseAppToRaw(void *raw, int &len) {
    ...
    *((char*)raw) = (char)(intval & 0x000000ff);
    len += sizeof(char);
    return true;
  }
